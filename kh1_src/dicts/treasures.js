...
export function treasure_dicts(obj) {
    ...
    function treasure_chests(self) {
        let item_0200 = "Power Up"
        let item_0640 = "Dalmatians 13, 14, 15"
        let item_0641 = "Aero-G"
        let item_0642 = "Dalmatians 58, 59, 60"
        let item_0643 = "Shell-G"
        let item_0680 = "Thundara-G"
        let item_0700 = "Aeroga-G 2"
        let item_0783 = "Protera Chain"
        let item_0A81 = "Thunder-G"
        let item_1501 = "Firaga-G"
        let item_1502 = "Holy-G"
        // Neverland
        let item_1781 = "Meteor-G"
        let item_1782 = "Dispel-G 1"
        let item_17C0 = "Dispel-G 8"
        let item_17C1 = "Dispel-G 4"
        let item_17C2 = "Protega Chain"
        let item_17C3 = "Shell-G 7"
        let item_1903 = "Dalmatians 43, 44, 45"
        let item_1940 = "Dalmatians 82, 83, 84"
        // Hollow Bastion
        let item_1980 = "Dispel-G"
        let item_19C3 = "Holy-G"
        let item_1A41 = "Power Up"
        let item_1AC1 = "Float-G 2"
        let item_1B40 = "Flare-G"
        let item_1B42 = "Float-G 2"
        let item_1B43 = "Float-G 1"
        let item_1BC3 = "Flare-G"
        // End of the World
        let item_1C40 = "Power Up"
        let item_1C41 = "Defense Up"
        let item_1C42 = "Megalixir"
        let item_1C43 = "Omega Arts"
        let item_1C80 = "Angel Bangle"
        let item_1C81 = "Megalixir"
        let item_1C82 = "Defense Up"
        let item_1C83 = "Three Stars"
        let item_1CC0 = "Power Up"
        let item_1CC1 = "Dark Ring"
        let item_1CC2 = "Thundara-G"
        let item_1CC3 = "Ultima-G"
        let item_1D00 = "Haste-G"
        let item_1D01 = "Haste2-G"
        let item_1D02 = "Esuna-G"
        let item_1D03 = "Brave Warrior"
        let item_1D40 = "Ifrit's Horn"
        let item_1D41 = "Inferno Band"
        let item_1D42 = "White Fang"
        let item_1D43 = "Ray of Light"
        let item_1D81 = "Holy Circlet"
        let item_1D82 = "Raven's Claw"
        let item_1DC0 = "Megalixir"
        if (self.fm) {
            item_0200 = "AP Up"
        ...
        return {
            ...
            "Traverse Town": {
                ...
                [`Mystical House Yellow Trinity: ${item_0200}`]: 0x0200,
                ...
                "Alleyway Behind Crates: Dalmatians 4, 5, 6": 0x0581,
            ...
            "Wonderland": {
                ...
                [`Queen's Castle Left Red Chest: ${item_0640}`]: 0x0640,
                [`Queen's Castle Right Blue Chest: ${item_0641}`]: 0x0641,
                [`Queen's Castle Right Red Chest: ${item_0642}`]: 0x0642,
                [`Lotus Forest Thunder Plant: ${item_0643}`]: 0x0643,
                [`Lotus Forest Painting Thunder Plant: ${item_0680}`]: 0x0680,
                ...
                [`Tea Party Garden Balcony: ${item_0700}`]: 0x0700,
            ...
            "Deep Jungle": {
                ...
                [`Tree House Rooftop: ${item_0783}`]: 0x0783,
                ...
                "Vines: Mythril": 0x0800,
                "Vines 2: Dalmatians 28, 29, 30": 0x0801,
            ...
            "Hundred Acre Woods": {
                ...
                [`Bouncing Spot Tree Alcove: ${item_0A81}`]: 0x0A81,
            ...
            "Olympus Coliseum": {
                ...
                [`Blizzara Puzzle: ${item_1501}`]: 0x1501,
                [`Blizzaga Puzzle: ${item_1502}`]: 0x1502,
            },
            "Monstro": {
            ...
            "Neverland": {
                [`Deck White Trinity: ${item_1781}`]: 0x1781,
                [`Crow's Nest: ${item_1782}`]: 0x1782,
                "Hold Right Yellow Trinity: Orichalcum": 0x1783,
                [`Hold Left Yellow Trinity: ${item_17C0}`]: 0x17C0,
                [`Galley: ${item_17C1}`]: 0x17C1,
                [`Cabin: ${item_17C2}`]: 0x17C2,
                [`Hold Flight 1st: ${item_17C3}`]: 0x17C3,
                [`Clock Tower: ${item_1903}`]: 0x1903,
                [`Hold Flight 2nd: ${item_1940}`]: 0x1940,
            ...
            "Hollow Bastion": {
                ...
                [`Rising Falls Under Water 1st: ${item_1980}`]: 0x1980,
                ...
                [`Castle Gates High Pillar: ${item_19C3}`]: 0x19C3,
                ...
                [`Entrance Hall Left of Emblem Door: ${item_1A41}`]: 0x1A41,
                ...
                [`Lift Stop Under Sliding Blocks: ${item_1AC1}`]: 0x1AC1,
                ...
                [`Waterway Blizzard on Bubble: ${item_1B40}`]: 0x1B40,
                "Waterway Unlock Passage: Thundaga-G": 0x1B41,
                [`Dungeon By Candles Chest: ${item_1B42}`]: 0x1B42,
                [`Dungeon Corner Chest: ${item_1B43}`]: 0x1B43,
                [`Grand Hall Steps Right Side: ${item_1BC3}`]: 0x1BC3,
            ...
            "End of the World": {
                [`Final Dimension 1st: ${item_1C40}`]: 0x1C40,
                [`Final Dimension 2nd: ${item_1C41}`]: 0x1C41,
                [`Final Dimension 3rd: ${item_1C42}`]: 0x1C42,
                [`Final Dimension 4th: ${item_1C43}`]: 0x1C43,
                [`Final Dimension 5th: ${item_1C80}`]: 0x1C80,
                [`Final Dimension 6th: ${item_1C81}`]: 0x1C81,
                [`Final Dimension 7th: ${item_1CC0}`]: 0x1CC0,
                [`Final Dimension 8th: ${item_1CC1}`]: 0x1CC1,
                [`Final Dimension 9th: ${item_1C83}`]: 0x1C83,
                [`Final Dimension 10th: ${item_1C82}`]: 0x1C82,
                [`Giant Crevasse 1st: ${item_1D00}`]: 0x1D00,
                [`Giant Crevasse 2nd: ${item_1D02}`]: 0x1D02,
                [`Giant Crevasse 3rd: ${item_1CC2}`]: 0x1CC2,
                [`Giant Crevasse 4th: ${item_1D01}`]: 0x1D01,
                [`Giant Crevasse 5th: ${item_1CC3}`]: 0x1CC3,
                [`Traverse Town: ${item_1D03}`]: 0x1D03,
                [`Wonderland: ${item_1D40}`]: 0x1D40,
                [`Olympus Coliseum: ${item_1D41}`]: 0x1D41,
                [`Deep Jungle: ${item_1D42}`]: 0x1D42,
                [`Agrabah: ${item_1D43}`]: 0x1D43,
                "Atlantica: AP Up": 0x1D80,
                [`Halloween Town: ${item_1D81}`]: 0x1D81,
                [`Neverland: ${item_1D82}`]: 0x1D82,
                "Hundred Acre Woods: Megalixir": 0x1D83,
                [`Hollow Bastion: ${item_1DC0}`]: 0x1DC0,
                "Final Rest: Megalixir": 0x1DC1,
            },
        }
    }
    obj.treasure_dicts = treasure_chests(obj);
    obj.clam_dict = {
