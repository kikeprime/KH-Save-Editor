export function journal_dicts(obj) {
    obj.heartlessnames = [
        "Soldier", "Shadow",
...
export function trinity_dicts(obj) {
    obj.trinity_names = [
        "Trinity Jump",
        "Trinity Charge",
        "Trinity Ladder",
...
export function minigame_dicts(obj) {
    // All of them are times
...
function synthesis_dicts(obj) {
    function synth_dict(self) {
        if (self.fm) {
            return {
                "Mega-Potion": 0x07,
                "Cottage": 0x06,
