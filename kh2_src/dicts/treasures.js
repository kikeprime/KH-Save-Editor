export function treasure_dicts(obj) {
    // Icons
    const consumable = `<img src="assets/item-consumable.png" height="24" style="margin-bottom: -5px">`;
    const menu = `<img src="assets/item-tent.png" height="24" style="margin-bottom: -5px">`;
    const key = `<img src="assets/item-key.png" height="24" style="margin-bottom: -5px">`;
    const material = `<img src="assets/material.png" height="24" style="margin-bottom: -5px">`;
    const keyblade = `<img src="assets/weapon-keyblade.png" height="24" style="margin-bottom: -5px">`;
    const staff = `<img src="assets/weapon-staff.png" height="24" style="margin-bottom: -5px">`;
    const shield = `<img src="assets/weapon-shield.png" height="24" style="margin-bottom: -5px">`;
    const armor = `<img src="assets/armor.png" height="24" style="margin-bottom: -5px">`;
    const accessory = `<img src="assets/accessory.png" height="24" style="margin-bottom: -5px">`;
    const summon = `<img src="assets/ai-settings.png" height="24" style="margin-bottom: -5px">`;
    
    // Items
    const potion = consumable + "Potion";
    const hipotion = consumable + "Hi-Potion";
    const ether = consumable + "Ether";
    const elixir = consumable + "Elixir";
    const megapotion = consumable + "Mega-Potion";
    const megaether = consumable + "Mega-Ether";
    const megalixir = consumable + "Megalixir";
    const tent = menu + "Tent";
    const drive = menu + "Drive Recovery";
    const highdrive = menu + "High Drive Recovery";
    const strengthboost = menu + "Strength Boost";
    const magicboost = menu + "Magic Boost";
    const defenseboost = menu + "Defense Boost";
    const apboost = menu + "AP Boost";
    const blazingshard = material + "Blazing Shard";
    const blazingstone = material + "Blazing Stone";
    const blazinggem = material + "Blazing Gem";
    const blazingcrystal = material + "Blazing Crystal";
    const lightningshard = material + "Lightning Shard";
    const lightningstone = material + "Lightning Stone";
    const lightninggem = material + "Lightning Gem";
    const lightningcrystal = material + "Lightning Crystal";
    const frostshard = material + "Frost Shard";
    const froststone = material + "Frost Stone";
    const frostgem = material + "Frost Gem";
    const frostcrystal = material + "Frost Crystal";
    const lucidshard = material + "Lucid Shard";
    const lucidstone = material + "Lucid Stone";
    const lucidgem = material + "Lucid Gem";
    const lucidcrystal = material + "Lucid Crystal";
    const powershard = material + "Power Shard";
    const powerstone = material + "Power Stone";
    const powergem = material + "Power Gem";
    const powercrystal = material + "Power Crystal";
    const darkshard = material + "Dark Shard";
    const darkstone = material + "Dark Stone";
    const darkgem = material + "Dark Gem";
    const darkcrystal = material + "Dark Crystal";
    const mythrilshard = material + "Mythril Shard";
    const mythrilstone = material + "Mythril Stone";
    const mythrilgem = material + "Mythril Gem";
    const mythrilcrystal = material + "Mythril Crystal";
    const remembranceshard = material + "Remembrance Shard";
    const remembrancestone = material + "Remembrance Stone";
    const remembrancegem = material + "Remembrance Gem";
    const remembrancecrystal = material + "Remembrance Crystal";
    const brightshard = material + "Bright Shard";
    const brightstone = material + "Bright Stone";
    const brightgem = material + "Bright Gem";
    const brightcrystal = material + "Bright Crystal";
    const energyshard = material + "Energy Shard";
    const energystone = material + "Energy Stone";
    const energygem = material + "Energy Gem";
    const energycrystal = material + "Energy Crystal";
    const serenityshard = material + "Serenity Shard";
    const serenitystone = material + "Serenity Stone";
    const serenitygem = material + "Serenity Gem";
    const serenitycrystal = material + "Serenity Crystal";
    const manifestillusion = material + "Manifest Illusion";
    const lostillusion = material + "Lost Illusion";
    const orichalcum = material + "Orichalcum";
    const orichalcump = material + "Orichalcum+";
    const tornpages = key + "Torn Pages";
    
    function treasure_dict(self) {
        const treasure_dict = {
            "Twilight Town": [
                [
        ...
        if (self.fm) {
            treasure_dict["Hollow Bastion"][2].push(0x302, 0x303);
            treasure_dict["Hollow Bastion"].push(
                [
    ...
    obj.treasure_dict = treasure_dict(obj);
    
    function treasure_list(self) {
        const treasure_list = {
            "Twilight Town": [
                [
        ...
        if (self.fm) {
            ...
            treasure_list["Hollow Bastion"][2].push(apboost, powercrystal);
            treasure_list["Hollow Bastion"].push(
                [
    ...
    obj.treasure_list = treasure_list(obj);
    
    function treasure_zip(self) {
        const treasure_zip = {}
        for (const w of Object.keys(self.treasure_dict)) {
            const d = {};
            self.treasure_dict[w].flat().forEach((idx, i) => {
                d[idx] = self.treasure_list[w].flat()[i];
            });
            treasure_zip[w] = d;
        }
        return treasure_zip;
    }
    obj.treasure_zip = treasure_zip(obj);
}
